...
### 6. The use of the online channel effect on customer profitability and retention in 1999. 
```{r}
...
### 7. Profit Model and Tenure Model
```{r}
...
### 2000 predicted =  predict (lm, 2000)  (better to make a new dataset for 2000)

### could be percentage error / hit rate?????
```{r}
